...
var Repository = (function () {
    ...
    Repository.prototype.deleteUserMap = function (id_user, id_map) {
        ...
        return this.db.query(query, { id_user: id_user, id_map: id_map });
    };
    ...
    Repository.prototype.updateUserRol = function (id_user, id_layer, rol) {
        ...
        return this.db.query(query, { id_layer: id_layer, id_user: id_user });
    };
    Repository.prototype.deleteUserRol = function (id_user, id_layer) {
        return this.db.query('DELETE FROM roles WHERE id_user = ${id_user} AND id_layer = ${id_layer}', { id_user: id_user, id_layer: id_layer });
    };
    ...
    Repository.prototype.deleteUserGroup = function (id_user, group) {
        return this.db.query('DELETE FROM user_groups WHERE "id_user" = ${id_user} AND "group" = ${group}', { id_user: id_user, group: group });
    };
    ...
    Repository.prototype.deleteGroup = function (id) {
        return this.db.query('DELETE FROM groups WHERE id = ${id}', { id: id });
    };
    Repository.prototype.createMap = function (name) {
        var cs = new this.pgp.helpers.ColumnSet(['name'], { table: 'maps' });
        var values = [{ name: name }];
        var query = this.pgp.helpers.insert(values, cs) + ' RETURNING *';
        return this.db.query(query);
    };
    Repository.prototype.deleteMap = function (id_map) {
        return this.db.query('DELETE FROM maps WHERE id = ${id_map}', { id_map: id_map });
    };
    ...
    Repository.prototype.deleteDefaultMap = function (id_map) {
        return this.db.query('DELETE FROM default_maps WHERE id = ${id_map}', { id_map: id_map });
    };
    ...
    Repository.prototype.deleteMapLayer = function (id_map, id_layer) {
        return this.db.query('DELETE FROM map_layers WHERE id_map = ${id_map} AND id_layer = ${id_layer}', { id_map: id_map, id_layer: id_layer });
    };
    ...
    Repository.prototype.deleteMapBaselayer = function (id_map, id_base_layer) {
        return this.db.query('DELETE FROM map_base_layers WHERE id_map = ${id_map} AND id_base_layer = ${id_base_layer}', { id_map: id_map, id_base_layer: id_base_layer });
    };
    ...
    Repository.prototype.createBaselayer = function (service_url, layers) {
        return this.db.one("INSERT INTO base_layers(service_url, name) VALUES('${service_url#}', '${layers#}') RETURNING *", { service_url: service_url, layers: layers });
    };
